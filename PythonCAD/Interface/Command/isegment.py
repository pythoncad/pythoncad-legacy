...
from Interface.Command.icommand     import *
...
class ISegmentCommand(ICommand):
    ...
    def __init__(self,scene):
        super(ICommand, self).__init__(scene,SegmentCommand())
...
#        self.updateCommandValues()
    
    def goOnCommandImput(self):    
        """
            change the imput command 
        """

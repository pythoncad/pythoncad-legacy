...
class GTKImage(object):
    ...
    __inittool = {
        Tools.paste_tool.PasteTool : cmd.paste_mode_init,
        Tools.select_tool.SelectTool : cmd.select_mode_init,
        Tools.deselect_tool.DeselectTool : cmd.deselect_mode_init,
        Tools.point_tool.PointTool : cmd.point_mode_init,
        Tools.segment_tool.SegmentTool : cmd.segment_mode_init,
        Tools.rectangle_tool.RectangleTool: cmd.rectangle_mode_init,
        Tools.circle_tool.CircleTool : cmd.circle_center_mode_init,
        Tools.two_point_circle_tool.TwoPointCircleTool : cmd.circle_tp_mode_init,
        Tools.arc_tool.ArcTool : cmd.arc_center_mode_init,
        Tools.chamfer_tool.ChamferTool : cmd.chamfer_mode_init,
        Tools.fillet_tool.FilletTool: cmd.fillet_mode_init,
        Tools.fillet_two_line_tool.FilletTwoLineTool: cmd.fillet_two_line_mode_init,
        Tools.hatch_tool.HatchTool : cmd.hatch_mode_init,
        Tools.leader_tool.LeaderTool : cmd.leader_mode_init,
        Tools.polyline_tool.PolylineTool : cmd.polyline_mode_init,
        Tools.polygon_tool.PolygonTool : cmd.polygon_mode_init,
        Tools.hcline_tool.HCLineTool : cmd.hcline_mode_init,
        Tools.vcline_tool.VCLineTool : cmd.vcline_mode_init,
        Tools.acline_tool.ACLineTool : cmd.acline_mode_init,
        Tools.cline_tool.CLineTool : cmd.cline_mode_init,
        Tools.perpendicular_cline_tool.PerpendicularCLineTool: cmd.perpendicular_cline_mode_init,
        Tools.tangent_cline_tool.TangentCLineTool : cmd.tangent_cline_mode_init,
        Tools.ccircle_tangent_line_tool.CCircleTangentLineTool : cmd.two_circle_tangent_line_mode_init,
        Tools.parallel_offset_tool.ParallelOffsetTool : cmd.parallel_offset_mode_init,
        Tools.ccircle_tool.CCircleTool : cmd.ccircle_cpmode_init,
        Tools.two_point_ccircle_tool.TwoPointCCircleTool : cmd.ccircle_tpmode_init,
        Tools.tangent_ccircle_tool.TangentCCircleTool : cmd.tangent_ccircle_mode_init,
        Tools.two_point_tangent_ccircle_tool.TwoPointTangentCCircleTool : cmd.two_cline_tancc_mode_init,
        Tools.text_tool.TextTool : cmd.text_add_init,
        Tools.horizontal_move_tool.HorizontalMoveTool : gtkmodify.move_horizontal_init,
        Tools.vertical_move_tool.VerticalMoveTool : gtkmodify.move_vertical_init,
        Tools.move_tool.MoveTool : gtkmodify.move_twopoint_init,
        Tools.horizontal_stretch_tool.HorizontalStretchTool : gtkmodify.stretch_horizontal_init,
        Tools.vertical_stretch_tool.VerticalStretchTool : gtkmodify.stretch_vertical_init,
        Tools.stretch_tool.StretchTool : gtkmodify.stretch_xy_init,
        Tools.transfer_tool.TransferTool : gtkmodify.transfer_object_init,
        Tools.rotate_tool.RotateTool : gtkmodify.rotate_init,
        Tools.split_tool.SplitTool : gtkmodify.split_object_init,
        Tools.delete_tool.DeleteTool : gtkmodify.delete_mode_init,
        Tools.mirror_tool.MirrorTool : gtkmirror.mirror_mode_init,
        Tools.zoom_tool.ZoomTool : gtkmodify.zoom_init,
        Tools.linear_dimension_tool.LinearDimensionTool : cmd.linear_mode_init,
        Tools.horizontal_dimension_tool.HorizontalDimensionTool : cmd.horizontal_mode_init,
        Tools.vertical_dimension_tool.VerticalDimensionTool : cmd.vertical_mode_init,
        Tools.radial_dimension_tool.RadialDimensionTool : cmd.radial_mode_init,
        Tools.angular_dimension_tool.AngularDimensionTool : cmd.angular_mode_init,
        Tools.plot_tool.PlotTool : gtkprinting.plot_mode_init,
        Tools.zoom_tool.ZoomPan : gtkmodify.pan_init,
        }
...
#        return _rv
    ...
    def __currentPointChanged(self, img, *args):
        _x, _y = self.__image.getCurrentPoint().getCoords()
...
#---------------------------------------------------------------------------------------------------
    ...
    def setTolerance(self, new_tolerance):
        """
        Sets a new value for the tolerance.
        setTolerance()
        """
        self.__tolerance = new_tolerance

    tolerance = property(getTolerance, setTolerance, None, "Drawing tolerance.")
...
#---------------------------------------------------------------------------------------------------
##    def MakeMove(self, widget, event):
...
#---------------------------------------------------------------------------------------------------
    def ActiveSnapEvent(self,drwArea,event):
        """
            Snap Event
        """
        cursor=None
